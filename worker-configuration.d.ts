/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 26745941b48d0832220c60f0b328a5fe)
// Runtime types generated with workerd@1.20260701.1 2026-07-07 nodejs_compat
interface __BaseEnv_Env {
	PNPR_PUBLIC_URL: string;
	PNPR_SECRET: string;
	PNPR_R2_ACCOUNT_ID: string;
	PNPR_R2_BUCKET: string;
	PNPR_R2_ACCESS_KEY_ID: string;
	PNPR_R2_SECRET_ACCESS_KEY: string;
	PNPR_CONTAINER: DurableObjectNamespace<import("./src/index").PnprContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PnprContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PNPR_PUBLIC_URL" | "PNPR_SECRET" | "PNPR_R2_ACCOUNT_ID" | "PNPR_R2_BUCKET" | "PNPR_R2_ACCESS_KEY_ID" | "PNPR_R2_SECRET_ACCESS_KEY">> {}
}
